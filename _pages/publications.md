...
## Articles
1. [A Track-Before-Detect Trajectory Multi-Bernoulli Filter for Nested Superpositional Measurements](https://ieeexplore.ieee.org/document/11635865) -  S. Lynch, Á. F. García-Fernández, L. Devlin, IEEE Transactions on Signal Processing, 2026.
...
1. [An Entropic Metric for Measuring Calibration of Machine Learning Models](https://ceur-ws.org/Vol-4132/short53.pdf) - D Sumler, L Devlin, S Maskell, R Lane, Proceeding of TRUST-AI, 2025.
1. [Hess-MC2: Sequential Monte Carlo Squared using Hessian Information and Second Order Proposals](https://ieeexplore.ieee.org/document/11204343) - J. Murphy, C. Rosato, A. Millard, L. Devlin, P. Horridge, S. Maskell, Proceeding of the IEEE 35th International Workshop on Machine Learning for Signal Processing (MLSP), 2025.
